...
key_event_table = {
    ...
    (SDL_KEYDOWN, SDLK_LSHIFT): SHIFT_UP,
    (SDL_KEYDOWN, SDLK_RSHIFT): SHIFT_UP,
    (SDL_KEYUP, SDLK_LSHIFT): SHIFT_DOWN,
    (SDL_KEYUP, SDLK_RSHIFT): SHIFT_DOWN
}
...
class SleepState:
    ...
    def draw(boy):
        if boy.dir == 1:
            ...
            boy.image.clip_compostie_draw(boy.frame * 100, 200, 100, 100, -3.141592 / 2, '', boy.x + 25, boy.y - 25, 100, 100)
...
next_state_table = {
    ...
    DashState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: RunState, RIGHT_DOWN: RunState, SPACE: DashState, SHIFT_DOWN: DashState, SHIFT_UP: RunState}
}
